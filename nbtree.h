...
Program : non Binary tree, pengoperasian delete dengan sistem waris, insert, dan konversian non binary ke binary tree
*/
#ifndef nbtree_H
#define nbtree_H
#include <stdio.h>
...
/*---------Konversi non binary tree ke binary tree----------*/
